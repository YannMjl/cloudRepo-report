...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__shared_order_by_pipe__ = __webpack_require__("./src/app/shared/order-by.pipe.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__shared_report_service__ = __webpack_require__("./src/app/shared/report.service.ts");
...
var DisplayByDateComponent = (function () {
    function DisplayByDateComponent(popup, router, location, route, orderByPipe, reposervice) {
        this.popup = popup;
        this.router = router;
    ...
    DisplayByDateComponent.prototype.ngOnInit = function () {
        ...
        this.reposervice
            ...
            _this.reportByDateChart = _this.orderByPipe.transform(report, 'organization');
    ...
    DisplayByDateComponent.prototype.ConfirmDeleteEvent = function () {
        var _this = this;
        this.reposervice
    ...
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_5__angular_core__["ViewChild"])('popupViewByDate'),
        __metadata("design:type", __WEBPACK_IMPORTED_MODULE_0_ng2_opd_popup__["a" /* Popup */])
    ], DisplayByDateComponent.prototype, "popupByDate", void 0);
    DisplayByDateComponent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_5__angular_core__["Component"])({
            providers: [__WEBPACK_IMPORTED_MODULE_3__shared_order_by_pipe__["a" /* OrderByPipe */]],
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_0_ng2_opd_popup__["a" /* Popup */],
            ...
            __WEBPACK_IMPORTED_MODULE_3__shared_order_by_pipe__["a" /* OrderByPipe */],
            __WEBPACK_IMPORTED_MODULE_4__shared_report_service__["a" /* ReportService */]])
...
var ReportDetailComponent = (function () {
    function ReportDetailComponent(popup, router, http, datePipe, location, route, reportService) {
        this.popup = popup;
        this.router = router;
        this.http = http;
    ...
    ReportDetailComponent.prototype.ngOnInit = function () {
        ...
        this.reportService.getReportByName(this.orgName)
            ...
            _this.reverse = false;
            console.log('init reverse' + _this.reverse);
        });
        this.order = '-size';
        this.reportService
    ...
    ReportDetailComponent.prototype.setOrder = function (value) {
    ...
    ReportDetailComponent.prototype.ConfirmDeleteEvent = function () {
        var _this = this;
        this.reportService.deleteReportByName(this.orgName)
            .subscribe(function (report) { return (_this.reportByNames = report); });
        this.router.navigate(['/report']);
    };
    ReportDetailComponent.prototype.CancelDeleteEvent = function () {
        this.popupOrg.hide();
    };
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_5__angular_core__["ViewChild"])('popupViewByOrg'),
        __metadata("design:type", __WEBPACK_IMPORTED_MODULE_0_ng2_opd_popup__["a" /* Popup */])
    ], ReportDetailComponent.prototype, "popupOrg", void 0);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_ng2_opd_popup__ = __webpack_require__("./node_modules/ng2-opd-popup/index.js");
...
var FileUploadComponent = (function () {
    ...
    FileUploadComponent.prototype.CloseEvent = function () { this.popup1.hide(); };
    FileUploadComponent.prototype.GoBackEvent = function () {
        this.popup1.hide();
        this.router.navigate(['/report']);
    };
    FileUploadComponent.prototype.CloseUploadEvent = function () {
        this.model = null;
        this.myFile.nativeElement.value = '';
        this.popup2.hide();
    };
    FileUploadComponent.prototype.ViewUploadEvent = function () {
        this.popup2.hide();
...
var HeaderComponent = (function () {
    function HeaderComponent(popup, authService) {
        this.popup = popup;
        this.authService = authService;
...
var ReportsComponent = (function () {
    function ReportsComponent(popup, router, reportService) {
        this.popup = popup;
        this.router = router;
        this.reportService = reportService;
        this.Currentpae = 1;
    ...
    ReportsComponent.prototype.ConfirmDeleteEvent = function () {
        var _this = this;
        this.reportService
            .deleteReport()
    ...
    ReportsComponent.prototype.CancelDeleteEvent = function () {
        this.popupreport.hide();
    };
    __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_3__angular_core__["ViewChild"])('popupReport'),
        __metadata("design:type", __WEBPACK_IMPORTED_MODULE_0_ng2_opd_popup__["a" /* Popup */])
    ], ReportsComponent.prototype, "popupreport", void 0);
